            ...
            <div>
                ...
                <div class="space-y-6 text-gray-700">
                    <div class="flex items-start gap-4">
                        <div class="bg-[#E3D2BE]/30 p-3 rounded-full text-[#354A3D]">
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" value="{{ old('phone', auth()->check() ? auth()->user()->phone : '') }}" placeholder="Số điện thoại (Không bắt buộc)..." 
                                   class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#354A3D] focus:ring-1 transition">
                        </div>
                    </div>
