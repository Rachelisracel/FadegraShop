        ...
        <div class="w-full flex items-center justify-center p-6 sm:p-12">
            <div class="w-full max-w-md bg-white p-8 sm:p-10 rounded-3xl shadow-sm border border-black/5">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="font-serif text-3xl font-bold text-[#1F2937] mb-2">Đặt lại mật khẩu</h1>
                    <p class="text-gray-500 text-sm leading-relaxed">Vui lòng nhập mật khẩu mới cho tài khoản của bạn.</p>
                </div>
