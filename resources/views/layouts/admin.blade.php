...
<body class="bg-gray-50 text-gray-800 font-sans flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="bg-gradient-to-b from-fadegra-main to-[#1E3228] w-64 h-full flex flex-col transition-transform duration-300 fixed lg:relative z-50 -translate-x-full lg:translate-x-0 shadow-2xl lg:shadow-none">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1 sidebar-scroll">
            ...
            <a href="{{ route('admin.orders.index') }}" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl {{ request()->routeIs('admin.orders.*') ? 'active bg-white/10 text-white shadow-inner' : 'text-white/60 hover:text-white hover:bg-white/5' }} transition group">
                <div class="w-9 h-9 rounded-lg {{ request()->routeIs('admin.orders.*') ? 'bg-fadegra-accent text-white' : 'bg-white/5 text-white/60 group-hover:bg-white/10 group-hover:text-white' }} flex items-center justify-center transition">
            ...
            <a href="{{ route('admin.products.index') }}" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl {{ request()->routeIs('admin.products.*') ? 'active bg-white/10 text-white shadow-inner' : 'text-white/60 hover:text-white hover:bg-white/5' }} transition group">
                <div class="w-9 h-9 rounded-lg {{ request()->routeIs('admin.products.*') ? 'bg-fadegra-accent text-white' : 'bg-white/5 text-white/60 group-hover:bg-white/10 group-hover:text-white' }} flex items-center justify-center transition">
            ...
            <a href="{{ route('admin.users.index') }}" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl {{ request()->routeIs('users.*') ? 'active bg-white/10 text-white shadow-inner' : 'text-white/60 hover:text-white hover:bg-white/5' }} transition group">
