...
<div class="bg-gray-50 min-h-screen p-6 sm:p-10 font-sans">
    ...
    <!-- TÌM KIẾM & LỌC -->
    <form action="{{ route('admin.orders.index') }}" method="GET" class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6 flex flex-col sm:flex-row gap-4 justify-between items-center">
